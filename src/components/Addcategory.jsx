    ...
    return (
        <div className='absolute top-0 start-0 w-screen h-screen grid place-items-center bg-stone-950/75'>
            <form action='' method='' onSubmit={submitHandler} className='w-[80%] md:w-[40%] bg-teal-50 border rounded-lg p-5 dark:bg-teal-950'>
                <div className='mb-4'>
                    <label htmlFor='newcategory' className='block text-2xl font-bold mb-2'>
                        Add new category
                    </label>
                ...
                <div className='grid grid-cols-2 gap-2'>
                    <button type='reset' onClick={()=>setAddCategoryShow(false)} className='bg-gray-300 hover:bg-gray-400 rounded-sm cursor-pointer p-1 dark:bg-gray-400 dark:hover:bg-gray-500'>
                        Cancel
                    </button>
